...
export const Home = () => {
  ...
  const [slideList, setSlideList] = useState<string[]>([
    "https://cdn.marvel.com/content/1x/dpool2024004_marvelvsalien.jpg",
  ]);
  ...
  const [moviesList, setMoviesList] = useState<eachMovie[]>([
...

    {
      ...
      title: "Fluffy",
      overview:
        " Pop Culture fan can look up series, comics and events of their favorite characters.",
      genre: ["Action", "Horror"],
  ...
  const move_slider = (): void => {
    ...
    const itemNumber =
      movieList.querySelectorAll<HTMLImageElement>("img").length;
  ...
  const getMovies= ():any => {
    ...
    axios
      .get(
        "https://api.themoviedb.org/3/movie/popular?api_key=d690e22cc305f26ee731e993dbe748f7"
      )
      .then((response) => {
        ...
        newArray.map((elm) => {
          ...
          let each_elm: eachMovie = {
            title: elm.original_title,
            overview: elm.overview.slice(0, 80) + "...",
            poster_url:poster_path_base+elm.poster_path,
            genre: elm.genre_ids,
          ...
          console.log('this is our refined result : ', newArray2)
          //setMoviesList(newArray2);
        });
      })
    ...
    <div className="content-container">
      <div className="featured-content">
        <p className="featured-desc">
          ...
          dolor deserunt nam assumenda ipsa eligendi dolore, ipsum id fugiat quo
